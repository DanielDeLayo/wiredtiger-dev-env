...
RESULTS_DIR = "/Users/danieldelayo/Gits/wiredtiger/build/verify_results_skewed"
...
plt.title('Skewed Experiment: Increment-and-Freeze vs Real WiredTiger Stats')
plt.legend()
plt.grid(True)
plt.savefig('/Users/danieldelayo/.gemini/antigravity-ide/brain/49addd11-cce3-447a-9ea5-b59eabe37dca/verification_mrc_skewed.png')
print("Plot saved to verification_mrc_skewed.png")
