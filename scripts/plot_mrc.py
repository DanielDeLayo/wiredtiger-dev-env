...
plt.title('Miss Ratio Curve: Increment-and-Freeze vs Real WiredTiger Stats')
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(WORKSPACE, 'plots', 'verification_mrc.png'))
print("Plot saved to plots/verification_mrc.png")
